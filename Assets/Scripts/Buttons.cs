...
public class Buttons : MonoBehaviour
{
    ...
    private void Update() 
    {
        ...
        if(PlayerPrefs.GetString("운동하기버튼").Equals("비활성화")){  //운동하기 게임을 플레이 했다면 버튼 비활성화
        ...
        if(PlayerPrefs.GetString("식단하기버튼").Equals("비활성화")){  //식단하기 게임을 플레이 했다면 버튼 비활성화
        ...
        if(PlayerPrefs.GetString("공부하기버튼").Equals("비활성화")){  //공부하기 게임을 플레이 했다면 버튼 비활성화
